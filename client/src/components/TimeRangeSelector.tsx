...
export function TimeRangeSelector({ startDate, endDate, onChange, className = '' }: TimeRangeSelectorProps) {
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-center gap-4 bg-gray-900 p-2 rounded-lg border border-gray-800 ${className}`}>
