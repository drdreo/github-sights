    ...
    try {
        ...
        const result: ContributorDetail = {
            ...
            lastCommitAt: snapshot.last_commit_at
                ...
                : null,
            firstPrAt: snapshot.first_pr_at ? new Date(snapshot.first_pr_at).toISOString() : null,
            lastPrAt: snapshot.last_pr_at ? new Date(snapshot.last_pr_at).toISOString() : null,
